...
namespace Assignment_1
{
    class Program
    {
        ...
        {
            double totalEarnings = 0, totalTax;
            ...
            if (totalEarnings > 0)
            {
               totalTax = calculateTotalTaxesOwed(totalEarnings);
            }
        ...
        static double calculateTotalTaxesOwed(double totalEarnings)
        {
            double taxTemp;
            double totalTax, taxAt10, taxAt15, taxAt25, taxAt28, taxAt33, taxAt35, taxAt396;
